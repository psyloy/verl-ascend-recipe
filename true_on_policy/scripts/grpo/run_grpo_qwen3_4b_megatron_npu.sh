#!/usr/bin/env bash
# GRPO | Qwen3-4B (dense) | vLLM rollout | Megatron training | Ascend NPU
# Knobs:
...
project_name=${PROJECT_NAME:-verl_grpo_qwen3_dense}
experiment_name=${EXPERIMENT_NAME:-qwen3_4b_grpo_vllm_megatron}
...
logfile="./logs/test_qwen3_4b_grpo_dense_megatron_$(date +%Y%m%d_%H%M%S).log"
