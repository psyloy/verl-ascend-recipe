#!/usr/bin/env bash
# DAPO | Qwen3-30B-A3B (MoE) | vLLM rollout | Megatron training | Ascend NPU
# Knobs:
...
project_name=${PROJECT_NAME:-verl_dapo_qwen3_moe}
experiment_name=${EXPERIMENT_NAME:-qwen3_30b_a3b_dapo_vllm_megatron}
...
logfile="./logs/test_qwen3_30b_dapo_megatron_$(date +%Y%m%d_%H%M%S).log"
{
