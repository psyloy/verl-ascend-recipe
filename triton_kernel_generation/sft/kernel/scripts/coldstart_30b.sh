HDFS_LOG_PATH=${HDFS_LOG_PATH:-"/home/PLEASE_SET_YOUR_OWN/logs"}
HDFS_CHECKPOINT_PATH=${HDFS_CHECKPOINT_PATH:-"/mnt/PLEASE_SET_YOUR_OWN/ckpt/"}
HDFS_MODEL_PATH=${HDFS_MODEL_PATH:-"/mnt/PLEASE_SET_YOUR_OWN/model/"}
...
RUN_NAME=Qwen3-30B-A3B-Thinking
